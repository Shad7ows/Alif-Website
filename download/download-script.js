...
const osData = [
  {
    ...
    name: "لينكس",
    img: "LinuxOS.svg",
    link: "https://github.com/alifcommunity/TaifEditor/releases/download/v3.3.0/TaifInstaller-Linux-X64",
  ...
  },
  {
    ...
    name: "ويندوز",
    img: "WindowsOS.svg",
    link: "https://github.com/alifcommunity/TaifEditor/releases/download/v3.3.0/TaifInstaller-Win-X64.exe",
  ...
  },
  {
    ...
    name: "ماك",
    img: "MacOS.svg",
    link: "https://github.com/alifcommunity/TaifEditor/releases/download/v3.3.0/TaifInstaller-MacOS-X64.app.zip",
...
for (let i = 0; i < osData.length; i++) {
  ...
  cardsDiv.innerHTML += `
    ...
    osData[i].img
            ...
            <h5 class="vers">لغة ألف | نـ5.3.0</h5>
        </div>
    `;
    if (!isCurrent) { pos += 2};
}
